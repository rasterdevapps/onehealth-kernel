package com.onehealth.kernel.authorization.config;

import com.onehealth.kernel.auth.JwtTenantConverter;
import com.onehealth.kernel.auth.SecurityConfig;
...
public class AuthorizationSecurityConfig {
    ...
    private final SecurityConfig kernelSecurityConfig;

    public AuthorizationSecurityConfig(SecurityConfig kernelSecurityConfig) {
        this.kernelSecurityConfig = kernelSecurityConfig;
    }
